...
namespace Common.Common
{
    ...
    {        
        public void FieldCreation()
        {
            ...
            AddFields("OMRV", "IRFrmdt", "From Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddFields("OMRV", "IRTodt", "To Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddFields("OMRV", "IRCalType", "Type", SAPbobsCOM.BoFieldTypes.db_Alpha);

            AddFields("MRV1", "IRMatCost", "Material Cost", SAPbobsCOM.BoFieldTypes.db_Float,10,SAPbobsCOM.BoFldSubTypes.st_Price);
            AddFields("MRV1", "IRProCost", "Product Cost", SAPbobsCOM.BoFieldTypes.db_Float,10,SAPbobsCOM.BoFldSubTypes.st_Price);
            AddFields("MRV1", "IRBOMCost", "BOM Cost", SAPbobsCOM.BoFieldTypes.db_Float,10,SAPbobsCOM.BoFldSubTypes.st_Price);
